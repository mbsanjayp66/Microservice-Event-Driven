...
import com.twitter4j.twitter.to.kafka.service.exception.TwitterToKafkaServiceException;
...
public class MockKafkaStreamRunner implements StreamRunner {
    ...
    private final TwitterToKafkaConfigData twitterToKafkaServiceConfigData;

    private final TwitterKafkaListener twitterKafkaStatusListener;
    ...
    public MockKafkaStreamRunner(TwitterToKafkaConfigData configData,
    		TwitterKafkaListener statusListener) {
